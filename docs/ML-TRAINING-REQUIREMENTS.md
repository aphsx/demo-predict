...
Lifecycle ไม่ใช่ model score. มันบอกสถานะจากข้อมูลก่อน `cutoff_date` เพื่อแยกว่าใครใช้งานอยู่,
ใครไม่ active, ใครไม่เคยใช้งาน และ model ไหนควร predict ได้จริง
...
ถ้ามี column หรือ UI เดิมที่อ้างถึง output เหล่านี้ ให้ถือว่าเป็น legacy และควรถูกถอดออก
...
active web UI references removed
```
