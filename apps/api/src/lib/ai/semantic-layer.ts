...
export const SEMANTIC_TABLES: SemanticTable[] = [
  ...
  },
  {
    ...
    columns: [
      ...
      { name: "recommended_followup_date", type: "date", description: "Recommended customer follow-up date." },
      ...
      { name: "priority_score", type: "numeric", description: "Business priority score." },
      { name: "priority_reason", type: "text", description: "Reason behind the priority score." },
      { name: "recommended_action", type: "text", description: "Recommended next action." },
