 ...
 *
 * The create/delete/upload/retry handlers are stubs until the matching
 * Elysia routes land.
 */
"use client";
  ...
  return (
    <>
      <button
        ...
        disabled={uploading}
        className="h-7 px-2.5 rounded-md border border-gray-200 bg-white text-[11.5px] text-[color:var(--ink-2)] hover:bg-gray-50 inline-flex items-center gap-1 disabled:opacity-40"
      >
                        ...
                        <div className="flex items-center justify-end gap-1.5">
                          ...
                          {run.status === "done" && (
                            <a
                              ...
                              className="h-7 px-2.5 rounded-md border border-gray-200 bg-white text-[11.5px] text-[color:var(--ink-3)] hover:bg-gray-50 hover:text-[color:var(--moby-600)] inline-flex items-center gap-1"
                            >
